...
namespace breinstormin.tools.web.css {
	public static class HTMLRenderer {
        ...
        static string Render(Model.Declaration dec)
        {
			StringBuilder txt = new StringBuilder();
        ...
        static string Render(Model.SimpleSelector ss)
        {
			StringBuilder txt = new StringBuilder();

			if (ss.Combinator.HasValue) {
				switch (ss.Combinator.Value) {
                    case breinstormin.tools.web.css.Model.Combinator.PrecededImmediatelyBy: txt.Append(" <span class=\"combinator\">+</span> "); break;
                    case breinstormin.tools.web.css.Model.Combinator.ChildOf: txt.Append(" <span class=\"combinator\">&gt;</span> "); break;
                    case breinstormin.tools.web.css.Model.Combinator.PrecededBy: txt.Append(" <span class=\"combinator\">~</span> "); break;
				}
			}
        ...
        static string Render(Model.Attribute atr)
        {
			StringBuilder txt = new StringBuilder();
			...
			if (atr.Operator.HasValue) {
				switch (atr.Operator.Value) {
                    case Model.AttributeOperator.Equals: txt.Append("<span class=\"operator\">=</span>"); break;
                    case Model.AttributeOperator.InList: txt.Append("<span class=\"operator\">~=</span>"); break;
                    case Model.AttributeOperator.Hyphenated: txt.Append("<span class=\"operator\">|=</span>"); break;
                    case Model.AttributeOperator.BeginsWith: txt.Append("<span class=\"operator\">$=</span>"); break;
                    case Model.AttributeOperator.EndsWith: txt.Append("<span class=\"operator\">^=</span>"); break;
                    case Model.AttributeOperator.Contains: txt.Append("<span class=\"operator\">*=</span>"); break;
				}
