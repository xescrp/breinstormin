...
namespace breinstormin.tools.web.css {
	...
	public class Parser {
        ...
        public Model.CSSDocument CSSDoc;
        ...
        void medium(out Model.Medium m)
        {
            m = Model.Medium.all;
			switch (la.kind) {
				case 12: {
				...
				case 13: {
						Get();
                        m = Model.Medium.aural;
						break;
					}
				case 14: {
						Get();
                        m = Model.Medium.braille;
						break;
					}
				case 15: {
						Get();
                        m = Model.Medium.embossed;
						break;
					}
				case 16: {
						Get();
                        m = Model.Medium.handheld;
						break;
					}
				case 17: {
						Get();
                        m = Model.Medium.print;
						break;
					}
				case 18: {
						Get();
                        m = Model.Medium.projection;
						break;
					}
				case 19: {
						Get();
                        m = Model.Medium.screen;
						break;
					}
				case 20: {
						Get();
        ...
        void simpleselector(out Model.SimpleSelector ss)
        {
            ss = new Model.SimpleSelector();
			ss.ElementName = "";
			string psd = null;
            breinstormin.tools.web.css.Model.Attribute atb = null;
            Model.SimpleSelector parent = ss;
			string ident = null;
			...
			while (StartOf(13)) {
                Model.SimpleSelector child = new Model.SimpleSelector();
				if (la.kind == 33) {
					Get();
					if (la.kind == 24) {
						Get();
        ...
        void attrib(out breinstormin.tools.web.css.Model.Attribute atb)
        {
            atb = new breinstormin.tools.web.css.Model.Attribute();
			atb.Value = "";
			string quote = null;
			string ident = null;
			...
			if (StartOf(14)) {
				switch (la.kind) {
					case 36: {
							Get();
                            atb.Operator = Model.AttributeOperator.Equals;
							break;
						}
					case 37: {
							Get();
                            atb.Operator = Model.AttributeOperator.InList;
							break;
						}
					case 38: {
							Get();
                            atb.Operator = Model.AttributeOperator.Hyphenated;
							break;
						}
					case 39: {
							Get();
                            atb.Operator = Model.AttributeOperator.EndsWith;
							break;
						}
					case 40: {
							Get();
                            atb.Operator = Model.AttributeOperator.BeginsWith;
							break;
						}
					case 41: {
							Get();
                            atb.Operator = Model.AttributeOperator.Contains;
							break;
						}
				}
				while (la.kind == 4) {
