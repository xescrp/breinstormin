...
namespace DotNet.Tools.TerminalServer
{
    ...
    public interface ITerminalServicesSession
    {
        ...
        /// </summary>
        WIN32.Win32API.ConnectionState ConnectionState { get; }
        ...
        void MessageBox(string text, string caption, WIN32.Win32API.RemoteMessageBoxIcon icon);
        ...
        WIN32.Win32API.RemoteMessageBoxResult MessageBox(string text, string caption, WIN32.Win32API.RemoteMessageBoxButtons buttons,
                                          WIN32.Win32API.RemoteMessageBoxIcon icon, 
                                          WIN32.Win32API.RemoteMessageBoxDefaultButton defaultButton,
        ...
        /// </remarks>
        void StartRemoteControl(ConsoleKey hotkey, WIN32.Win32API.RemoteControlHotkeyModifiers hotkeyModifiers);
